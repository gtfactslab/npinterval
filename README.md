...
- Python ≥ 3.8
- NumPy ≥ 2.0
- Boost headers (`libboost-dev` on Debian/Ubuntu, `brew install boost` on macOS)
...
contains the real number the float approximates. Pass `exact=True` to use the values
as-is:
