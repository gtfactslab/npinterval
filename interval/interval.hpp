...
// Boost interval policy: directed rounding for arithmetic,
// std transcendental functions (requires -frounding-math for strict correctness)
...
// C-compatible storage struct — two consecutive doubles, same layout as before.
// This is the element type stored in NumPy arrays.
struct interval {
...
// elementwise min/max of bounds (no Boost equivalent needed)
